...
const Contact = ({dark}) => {
  ...
  const shadow = dark==="false" ? "0px 5px 25px rgba(0, 0, 0, 0.3)" : "0px 5px 25px rgba(0, 0, 0, 35)"

  return(
    <div id="contact"  className="flex flex-col items-center mt-16">
      {dark==="false" ?
        <h2 className="text-4xl p-1 mb-14 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-violet-500">Contacto</h2>
      :
        <h2 className="text-4xl p-1 mb-10 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-great-blue-500 via-violet-600 to-emerald-700">Contacto</h2>
      }
