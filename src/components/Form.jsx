    ...
    <div className='w-full max-w-lg p-7 justify-center mb-10'>
      <form ref={data} onSubmit={formik.handleSubmit}>
        ...
        <input
          ...
          name='name'
          placeholder='Nombre'
          className='shadow border border-gray-300 rounded-lg bg-gray-100 w-full max-w-lg h-12 py-2 px-3 text-gray-700 leading-tight focus:outline-blue-300 dark:bg-transparent dark:text-white'
        ...
        <motion.button
          ...
          type='submit'
          className='border rounded-md text-lg mt-3 py-2 px-6 bg-cyan-800 text-white'
        >
          Enviar
        </motion.button>
      </form>
