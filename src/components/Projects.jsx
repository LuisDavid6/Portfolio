...
const projects = [
  {
    ...
    description:
      'SPA que filtra información sobre los paises con opción de agregar actividades turisticas a los mismos.',
  ...
  },
  {
    ...
    description:
      'Clon de netflix con autenticación de usuarios, listado y visualización de peliculas ',
