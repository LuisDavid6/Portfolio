      ...
      <div className="mt-5 mb-1 flex flex-wrap justify-center max-w-2xl gap-4">
        {techs.map(e => 
          <motion.div 
            ...
            key={e.name} className="grid gap-2 justify-items-center cursor-grab border rounded-lg p-3 shadow-2xl font-semibold dark:text-slate-50 dark:bg-zinc-700 hover:scale-110">
